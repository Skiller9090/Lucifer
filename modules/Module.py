...
class BaseModule(RetrieveShell):
    ...
    def pre_setup(self):
        """
        This is a setup hook which runs on module load.

        This happens first on load.
        """

    def setup(self):
        """
        This is a setup hook which will be run on module load.

        This happens after getting luciferManager and getting shell.
        """

    def post_setup(self):
        """
        This is the final setup hook which will run last on module setup.

        This happens after setting desc and vars.
        """
